...
The release evidence set was reviewed and reduced to the following publishable
facts:
...
- Capture placeholder screenshots from a synthetic dataset instead of a personal
  account.
- Keep raw diagnostics out of Git history and release assets; publish only
  summarized, public findings.
