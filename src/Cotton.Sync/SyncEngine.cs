...
namespace Cotton.Sync
{
    ...
    public class SyncEngine : ISyncEngine
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            LocalTreeLookupSnapshot? localTreeLookups = await _treeScanner.ScanLocalTreeLookupsAsync(
                    syncPair.LocalRootPath,
            ...
            LocalTreeSnapshot localTree = await _treeScanner.ScanLocalTreeAsync(
                    syncPair.LocalRootPath,
                    silentPreflightOptions,
                    startedAtUtc,
                    cancellationToken)
