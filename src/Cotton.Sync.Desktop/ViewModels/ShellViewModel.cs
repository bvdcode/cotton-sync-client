...
namespace Cotton.Sync.Desktop.ViewModels
{
    ...
    internal partial class ShellViewModel : ViewModelBase, IDisposable, IAsyncDisposable
    {
        ...
        private readonly LinkedList<Action> _pendingSyncEvents = new();
        ...
        private readonly Dictionary<Guid, DesktopRunProgressSnapshot> _latestRunProgressByPair = [];
        ...
        private bool _isSyncEventDispatchQueued;
        private bool _isDisposed;
        private int _sessionEventRevision;
        ...
        private LinkedListNode<Action>? _pendingStatusEvent;
        private LinkedListNode<Action>? _pendingTransferEvent;
        private LinkedListNode<Action>? _pendingRunEvent;
