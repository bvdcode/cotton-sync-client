...
Assert-Contains -Content $explorerAlwaysKeepDuringPopulation -Expected "Late-created descendants inherited Always keep before initial population completed." -Label "vfs-smoke\phase-explorer-always-keep-during-population\cloud-files-vfs-smoke.stdout.log"
