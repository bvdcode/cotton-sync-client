...
if [ "$#" -eq 0 ]; then
  set -- connecting sign-in-error empty-dashboard add-folder dashboard folder-controls progress many-small-download settings settings-diagnostics error conflict
fi
